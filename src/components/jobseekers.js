    ...
    {data
                && <div className='container'>
                    ...
                    .filter((item) =>{
                        ...
                        else if(item.job_type.toLowerCase().includes(search.toLowerCase())){
                            return item;
                        }
                    })
                    .map(item=>(
      ...
      <div className='card-style'>
        <div className='image'>
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQrb7XeVpElaj3yF0M2zBadpBwR1H32HQQumw&usqp=CAU" alt='logo'/>
       </div>
       </div> 
        <div className='card-information'>
          ...
          <div><hr/></div>
          <div className='card-style'>
          <button key={item.id} onClick={()=>{handleToggle(item.id)}} type="submit" className="card-button">
